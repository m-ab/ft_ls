...
#    Updated: 2016/02/26 18:41:43 by mbouhier         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = main.c parse.c error.c get_data.c sort.c ft_ls.c 
...
$(NAME): $(OBJ) $(INCLUDE)
	...
	@make -C libft/
	@gcc $(FLAGS) -c $(INC) $(SRC)
	@gcc $(FLAGS) -o $(NAME) -L./libft -lft $(INC) $(OBJ)
...
.PHONY: clean fclean re all norme check
